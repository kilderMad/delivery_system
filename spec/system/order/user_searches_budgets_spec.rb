...
describe 'User does budgets' do
  it 'and sees budgets' do
    ...
    Price.create!(cbm_min: 0.001, cbm_max: 1.500, weight_min: 1, weight_max: 100, value_km: 0.05, carrier: carrier1)
    Price.create!(cbm_min: 1.501, cbm_max: 3.500, weight_min: 1, weight_max: 100, value_km: 0.09, carrier: carrier1)
    Price.create!(cbm_min: 3.501, cbm_max: 6.500, weight_min: 1, weight_max: 100, value_km: 0.12, carrier: carrier1)
    Price.create!(cbm_min: 0.001, cbm_max: 1.500, weight_min: 1, weight_max: 100, value_km: 0.04, carrier: carrier2)
    Price.create!(cbm_min: 1.501, cbm_max: 3.500, weight_min: 1, weight_max: 100, value_km: 0.10, carrier: carrier2)
    Price.create!(cbm_min: 3.501, cbm_max: 6.500, weight_min: 1, weight_max: 100, value_km: 0.13, carrier: carrier2)
    Price.create!(cbm_min: 0.001, cbm_max: 1.500, weight_min: 1, weight_max: 100, value_km: 0.04, carrier: carrier3)
    Price.create!(cbm_min: 1.501, cbm_max: 3.500, weight_min: 1, weight_max: 100, value_km: 0.08, carrier: carrier3)       
