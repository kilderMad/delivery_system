...
describe 'user visits orders' do
  it '(admin) and sees all orders' do
    ...
    Price.create!(cbm_min: 0.301, cbm_max: 1.500, weight_min: 1, weight_max: 30, value_km: 0.05, carrier: carrier1)
    Price.create!(cbm_min: 0.301, cbm_max: 1.500, weight_min: 31, weight_max: 500, value_km: 0.08, carrier: carrier2) 
    order1 = Order.new(distance: 2000, weight: 1.0, cubic_size: 0.4, pickup_address: 'blablabla', receiver_address: 'blableblu',
                  receiver_name: 'Madson kilder filho', receiver_cpf: '71315516699', receiver_phone: '81981316988', carrier: carrier1)
    order2 = Order.new( distance: 1000, weight: 45.0, cubic_size: 0.5, pickup_address: 'plablabla', receiver_address: 'plableblu',
                  receiver_name: 'Simba kilder ferreira', receiver_cpf: '12215516699', receiver_phone: '90991316988', carrier: carrier2)
    order1.save
    order2.save
  ...
  it '(user) and sees all orders' do
    ...
    Price.create!(cbm_min: 0.301, cbm_max: 1.500, weight_min: 1, weight_max: 30, value_km: 0.05, carrier: carrier1)
    Price.create!(cbm_min: 0.301, cbm_max: 1.500, weight_min: 31, weight_max: 500, value_km: 0.08, carrier: carrier2) 
    Order.create!(distance: 1000, weight: 1.0, cubic_size: 0.4, pickup_address: 'blablabla', receiver_address: 'blableblu',
                  receiver_name: 'Madson kilder filho', receiver_cpf: '71315516699', receiver_phone: '81981316988', deadline: 6, carrier: carrier1)
    Order.create!(distance: 2000, status: 2, weight: 41.3, cubic_size: 0.5, pickup_address: 'plablabla', receiver_address: 'plableblu',
