...
describe 'user register new order' do
  ...
  it 'success' do
    ...
    Price.create!(cbm_min: 0.301, cbm_max: 1.500, state: 'PE', deadline: 8, value: 75, carrier: carrier)
    Price.create!(cbm_min: 1.501, cbm_max: 3.500, state: 'PE', deadline: 9, value: 45, carrier: carrier)
